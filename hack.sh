...
git clone https://github.com/greenemeraldpro/Tricks.git
git clone https://github.com/greenemeraldpro/spoofer.git
git clone https://github.com/greenemeraldpro/nmap
